/**
 * 配合源码org.springframework.security.web.authentication.www.DigestAuthenticationFilter整改
 * 原码为org.springframework.security.web.authentication.www.DigestAuthUtils
 * 代码没有做任何改动
 */
...
public final class DigestAuthUtils {
    ...
    public static String generateDigest(boolean passwordAlreadyEncoded, String username, String realm, String password,
		...
		System.out.println("passwordAlreadyEncoded:" + passwordAlreadyEncoded + ", username=" + username + ", realm="
				+ realm + ", password=" + password + ", httpMethod=" + httpMethod + ", uri=" + uri + ", qop=" + qop
